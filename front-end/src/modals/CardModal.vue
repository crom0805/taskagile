                    ...
                    <div class="card-container">
                        ...
                        <div class="wrapper description-wrapper">
                            <div class="wrapper-body">
                                ...
                                <form class="description-form" @submit.prevent="changeCardDescription"
                                      v-show="editingDescription">
                                    <div class="form-group">
                                        <textarea id="cardDescription" class="auto-size"
                                ...
                                <div class="description" v-show="description && !editingDescription"
                                ...
                                <ul class="list-unstyled">
                                    <li class="media" v-for="attachment in cardAttachments" v-bind:key="attachment.id">
                                        ...
                                        <div class="media-body">
                                            <h6 class="mt-0 mb-1"><a :href="attachment.fileUrl" target="_blank">{{
                                                attachment.fileName }}</a></h6>
                        ...
                        <div class="wrapper activities-wrapper">
                            ...
                            <div class="wrapper-body">
                                <div class="activity" v-for="activity in cardActivities" v-bind:key="activity.id">
                                    <div><strong>{{ activity.user.name }}</strong> <span class="when">{{ activity.when }} ago</span>
                                    </div>
