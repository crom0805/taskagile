                    ...
                    <div class="form-group">
                        ...
                        <div class="field-error" v-if="$v.form.username.$dirty">
                            ...
                            <div class="error" v-if="!$v.form.username.minLength">{{
                                $t('registerPage.form.username.minLength', {minLength:
                                $v.form.username.$params.minLength.min}) }}
                            </div>
                            <div class="error" v-if="!$v.form.username.maxLength">{{
                                $t('registerPage.form.username.maxLength', {maxLength:
                    ...
                    <div class="form-group">
                        ...
                        <div class="field-error" v-if="$v.form.emailAddress.$dirty">
                            ...
                            <div class="error" v-if="!$v.form.emailAddress.maxLength">{{
                                $t('registerPage.form.emailAddress.maxLength', {maxLength:
                                $v.form.emailAddress.$params.maxLength.max}) }}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="field-error" v-if="$v.form.firstName.$dirty">
                            ...
                            <div class="error" v-if="!$v.form.firstName.minLength">{{
                                $t('registerPage.form.firstName.minLength', {minLength:
                                $v.form.firstName.$params.minLength.min}) }}
                            </div>
                            <div class="error" v-if="!$v.form.firstName.maxLength">{{
                                $t('registerPage.form.firstName.maxLength', {maxLength:
                                $v.form.firstName.$params.maxLength.max}) }}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="field-error" v-if="$v.form.lastName.$dirty">
                            ...
                            <div class="error" v-if="!$v.form.lastName.alpha">{{ $t('registerPage.form.lastName.alpha')
                                }}
                            </div>
                            <div class="error" v-if="!$v.form.lastName.minLength">{{
                                $t('registerPage.form.lastName.minLength', {minLength:
                                $v.form.lastName.$params.minLength.min}) }}
                            </div>
                            <div class="error" v-if="!$v.form.lastName.maxLength">{{
                                $t('registerPage.form.lastName.maxLength', {maxLength:
                                $v.form.lastName.$params.maxLength.max}) }}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="field-error" v-if="$v.form.password.$dirty">
                            ...
                            <div class="error" v-if="!$v.form.password.minLength">{{
                                $t('registerPage.form.password.minLength', {minLength:
                                $v.form.password.$params.minLength.min}) }}
                            </div>
                            <div class="error" v-if="!$v.form.password.maxLength">{{
                                $t('registerPage.form.password.maxLength', {maxLength:
                                $v.form.password.$params.maxLength.max}) }}
                            </div>
                        </div>
                    </div>
                    <button type="submit" class="btn btn-primary btn-block">{{ $t('registerPage.form.submit') }}
                    </button>
